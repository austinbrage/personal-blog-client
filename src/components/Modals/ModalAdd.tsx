...
export function ModalAdd({ modalRef, toggleModal }: Props) {
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="p-4 md:p-5">
                        ...
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div className="col-span-2">
                                <label htmlFor="title1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    Title
                                </label>
                                <input 
                                    required
                            ...
                            <div className="col-span-2">
                                <label htmlFor="description1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    Article Description
                                </label>
                                <textarea 
                                    required
